...
<main role="main" class="container">
    ...
    <hr>
    {!! Form::model($workerForEdit, [
        'route' => ['worker.update', $workerForEdit->id],
        'method' => 'PUT',
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
            ...
            <br>
            <img width="100px" src="/storage/images/workers/{{ $workerForEdit->image }}">
            <br>
            <br>
            <label for="inputEmail4">Загрузить новую фотографию</label>
            <br>
